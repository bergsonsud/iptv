...
#Rails.application.config.assets.precompile += %w( teste.css )
...
# Rails.application.config.assets.precompile += %w( intlTelInput.min.css )
...
# Rails.application.config.assets.precompile += %w( intlTelInput.min.js )
...
# Rails.application.config.assets.precompile += %w( tilt.jquery.min.js )
